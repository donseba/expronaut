...
func TestDateFunc(t *testing.T) {
	input := `date("2006-01-02") == date("2006-01-02")`
...
func TestArrayReduce(t *testing.T) {
	input := `reduce(int[1,2,3,4,5],"add", 0)`
...
func TestArrayMap(t *testing.T) {
	input := `map(int[1,2,3,4,5], double)`
